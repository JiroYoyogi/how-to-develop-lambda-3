...
# 「いいね」をGET・POST（リクエストボディを扱う）

## 手順

1. DynamoDBを作成（誰がどの記事にいいねをしたか？）
1. Lambdaを作成
1. API Gatewayを作成・Lambdaと連携
1. フロントのコードから「いいね」をPOSTしてみる
...
参考：PutItemCommandのリファレンスは[こちらから](https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/dynamodb/command/PutItemCommand/)
...
QueryCommandのリファレンスは[こちらから](https://docs.aws.amazon.com/AWSJavaScriptSDK/v3/latest/client/dynamodb/command/QueryCommand/)
